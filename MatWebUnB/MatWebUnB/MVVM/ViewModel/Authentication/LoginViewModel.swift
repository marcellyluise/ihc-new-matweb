...
class LoginViewModel {
    ...
    private func setupFields() {
        let registrationField = LoginField(placeholder: "Digite sua matrícula", fieldValue: nil, type: .registration, formatter: MaskFormatter.registrationNumber, validators: [.required()], icon: #imageLiteral(resourceName: "registration-icon"))
